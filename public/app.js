...
function renderMenu(filterCat) {
  ...
  let itemsToShow = menu;
  if (filterCat !== 'all') {
    itemsToShow = menu.filter(item => item.category === filterCat);
  }
  ...
  grid.innerHTML = itemsToShow.map(item => `
    <div class="menu-item" onclick="addToCart(${item.id})">
      ...
      <div class="item-content">
        ...
        <div class="item-desc">${item.desc}</div>        <div class="item-footer">
  ...
  container.innerHTML = cart.map(item => `
    <div class="cart-item">
      <div class="cart-item-info">
        ...
        <div class="cart-item-qty">× ${item.qty}</div>      </div>
...
loadMenu();const tg = window.Telegram.WebApp;
tg.ready();
tg.expand();
